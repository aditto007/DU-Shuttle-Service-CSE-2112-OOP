...
public class Quickbotguest extends JFrame implements ActionListener {
    ...
    Quickbotguest() {
        ...
        lblIntro.setBounds(150, 30, 600, 60); // Adjust bounds for proper visibility
        add(lblIntro);
        ...
        // Button for Payment Information
